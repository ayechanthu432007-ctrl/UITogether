...
> The frontend is **not** part of this folder. It will be a separate plain
...
Everything else (creating the database, all 9 tables, 2 views, 5 triggers) is
...
database/      migrations, seed, schema.sql, automation scripts
```
