...
router.post('/', writeLimiter, createRules, validate, lostFoundController.create);
router.patch('/:id', idParam('id', 'item_id'), updateRules, validate, lostFoundController.update);
router.patch(
  '/:id/status',
  idParam('id', 'item_id'),
  statusRules,
